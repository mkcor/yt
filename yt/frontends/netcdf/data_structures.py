...
class NetcdfHierarchy(GridIndex):
    ...
    def __init__(self, ds, dataset_type='netcdf'):
...
class NetcdfDataset(Dataset):
    ...
    _field_info_class = NetcdfFieldInfo

    def __init__(self, filename, dataset_type='netcdf',
                 storage_filename=None,
                 units_override=None):
        self.fluid_types += ('netcdf',)
